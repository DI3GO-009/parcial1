  ...
  <div>
    ...
    <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
      <ul id="sidebarnav">
        ...
        <li class="sidebar-item">
          <a class="sidebar-link" href="pacientes/pacientes.php" target="base" aria-expanded="false">
            <span>
        ...
        <li class="sidebar-item">
          <a class="sidebar-link" href="tratamiento/tratamiento.php" target="base" aria-expanded="false">
            <span>
            <i class="ti ti-pill"></i>
            </span>
            <span class="hide-menu">Tratamiento</span>
          </a>
        </li>
        <!-- <li class="sidebar-item">
